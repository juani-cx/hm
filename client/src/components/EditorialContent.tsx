  ...
  return (
    <div className="max-w-md mx-auto px-4 py-8 space-y-8">
        ...
        {articles.map((article, index) => (
          ...
          >
            <Card className="overflow-hidden hover-elevate cursor-pointer" data-testid={`article-${index}`}>
              ...
              <div className="p-4">
                <h3 className="font-serif font-semibold text-xl mb-2">{article.title}</h3>
      ...
      >
        ...
        <Card className="p-6 bg-gradient-to-br from-accent/10 via-accent/5 to-background border-accent/20">
          <div className="flex items-start gap-4">
            <div className="p-3 rounded-full bg-accent/10">
              <Plus className="w-6 h-6" />
            </div>
            <div className="flex-1">
              <h3 className="font-serif font-semibold text-xl mb-2">Create Your Collection</h3>
              <p className="text-sm text-muted-foreground mb-4">
